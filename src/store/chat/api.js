...
export const getChats = async () => {
    try {
        const response = await currentApi.get(`/get_all_conversations`);
...
export const addChat = async (chatData) => {
    try {
        ...
        const response = await currentApi.get(`/get_conversation_by_whatsapp_number/${chatData.phoneNumber}`,);
...
export const updateChat = async (chatData) => {
    try {
        console.log('chatData', chatData)
        if (!chatData) throw new Error("Dados de chat inválidos");
        const response = await currentApi.put(`/update_conversation`, chatData);
        return response.data;
    } catch (error) {
...
export const addMessage = async (messageData) => {
    try {
        ...
        const response = await currentApi.post(`/add_message`, messageData);
...
export const getMessages = async (telephone) => {
    try {
        ...
        const response = await currentApi.get(`/get_conversation_by_whatsapp_number/${telephone}`);
        return response.data;
    } catch (error) {
